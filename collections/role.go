...
// Role
// role collections provides methods for you to manage array data more easily.
type Role []models.Role

// Origin
// convert the collection to role array.
// @return []models.Role
...
// IDs
// returns an array of the role array's ids.
// @return []uint
...
// Names
// returns an array of the role array's names.
// @return []string
...
// Permissions
// returns uniquely the permissions of the roles in the role collection.
// @return Permission
